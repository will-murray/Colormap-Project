...
#
awk 'NR <= 200000 {print}' ecoli_data/SRR13921543_1.fastq > ecoli_data/SRR13921543_1_sub.fastq
awk 'NR <= 200000 {print}' ecoli_data/SRR13921543_2.fastq > ecoli_data/SRR13921543_2_sub.fastq
awk 'NR <= 30000 {print}' ecoli_data/SRR10971019.fasta > ecoli_data/SRR10971019_sub.fasta

split -l 50000 ecoli_data/SRR13921543_1.fastq
